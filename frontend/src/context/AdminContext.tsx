    ...
    try {
      ...
      if (networksRes.ok) {
        ...
        const mappedNetworks = rawNetworks.map((net: any) => ({
          ...
          englishName: net.english_name || '',
          externalLink: net.external_link || '',
          ownerName: net.user?.name || 'مجهول',
          ownerPhone: net.user?.phone || net.owner_phone || '',
      ...
      if (dataEditsRes.ok) {
        ...
        setDataEditRequests(rawEdits.map((e: any) => ({
          ...
          englishName: e.englishName || e.english_name,
          externalLink: e.externalLink || e.external_link,
