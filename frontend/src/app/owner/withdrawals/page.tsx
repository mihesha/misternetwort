...
import { WithdrawalRequestsListView } from '../../../components/owner/views/WithdrawalRequestsListView';

export default function WithdrawalRequestsListViewPage() {
