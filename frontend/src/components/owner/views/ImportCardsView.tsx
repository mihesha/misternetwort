  ...
  return (
    <div dir="rtl" className={`transition-colors font-['Cairo',sans-serif] ${isDarkMode ? 'bg-[#0a0f18] text-slate-100' : 'bg-slate-100 text-slate-800'}`}>
      <main className="max-w-4xl mx-auto px-4 md:px-6 py-8 space-y-6">
        ...
        <div className={`rounded-3xl p-6 md:p-10 border transition-all shadow-2xl relative overflow-hidden ${isDarkMode ? 'bg-gradient-to-br from-[#121926] to-[#0f172a] border-slate-800 text-slate-100 shadow-black/40' : 'bg-gradient-to-br from-white to-slate-50 border-slate-200 text-slate-900 shadow-blue-900/5'
          }`}>
          ...
          {!importStats && (
            <div className="relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              {/* Instructions Box */}
              <div className={`max-w-2xl mx-auto mb-10 rounded-3xl p-5 md:p-6 border transition-all text-right space-y-3 ${isDarkMode
              ...
              <div className="space-y-6 text-right max-w-2xl mx-auto">
                ...
                <div className="relative z-40">
                  <div
                    ...
                    className={`w-full rounded-2xl py-4 px-5 text-sm font-bold flex items-center justify-between cursor-pointer transition-all border shadow-sm ${isDarkMode
                  ...
                  {isCategoryDropdownOpen && (
                    <>
                      ...
                      <div className={`absolute top-full left-0 right-0 mt-2 z-40 rounded-2xl border shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 ${isDarkMode ? 'bg-[#1a2436] border-slate-700' : 'bg-white border-slate-200'
                        }`}>
                          ...
                          {categories.length === 0 ? (
                            ...
                            categories.map((c: any) => (
                              <div
                                ...
                                className={`w-full text-right p-3.5 rounded-xl text-sm font-bold cursor-pointer flex items-center justify-between transition-all ${String(selectedCategory) === String(c.id)
                ...
                <div className={`transition-all duration-500 ${!selectedCategory ? 'opacity-80 grayscale-[30%]' : ''}`}>
                  ...
                  >
                    <div className="pointer-events-none flex flex-col items-center justify-center space-y-4 w-full">
                      {isParsing ? (
                        ...
                        <div className="flex flex-col items-center space-y-3 animate-in zoom-in duration-300">
                          ...
                          <p className="text-xs text-blue-500 underline pt-2 pointer-events-auto hover:text-blue-400">انقر هنا لاختيار ملف آخر</p>
                        </div>
                      ) : (
                        <>
                ...
                <div className={`flex flex-col sm:flex-row items-center justify-center gap-3 pt-4 transition-all duration-500 ${extractedCards.length > 0 && !errorMessage ? 'opacity-100' : 'opacity-0 pointer-events-none hidden'}`}>
                  ...
                  <button
                    onClick={resetState}
                    disabled={isSuccess}
                    className={`w-full sm:w-auto px-8 py-3.5 rounded-2xl font-bold text-sm transition-all ${isDarkMode ? 'bg-[#1a2436] hover:bg-rose-500/10 text-slate-300 hover:text-rose-400' : 'bg-slate-100 hover:bg-rose-50 text-slate-600 hover:text-rose-600'
                      }`}
                  >
                    إلغاء التحديد
                  </button>
          ...
          {importStats && (
            <div className="relative z-10 animate-in zoom-in-95 duration-500 max-w-2xl mx-auto">
              <div className="text-center mb-10">
                <div className={`w-24 h-24 mx-auto rounded-full flex items-center justify-center mb-6 shadow-inner border ${importStats.valid === 0
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <button
                  ...
                  className={`w-full sm:w-auto px-8 py-4 rounded-2xl font-extrabold text-sm transition-all flex items-center justify-center gap-2 shadow-xl ${isDarkMode ? 'bg-[#1a2436] hover:bg-[#223049] text-slate-300 shadow-black/20' : 'bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 shadow-slate-200/50'
                    }`}
                >
